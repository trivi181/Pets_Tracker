  ...
  Widget build(BuildContext context) {
    ...
    return ExpansionTile(
      ...
      children: <Widget>[
        ...
        _buildAdvRow(context, 'Service UUIDs', getNiceServiceUuids(adv.serviceUuids.cast<String>())),
        _buildAdvRow(context, 'Service Data', getNiceServiceData(adv.serviceData.cast<String, List<int>>())),
      ],
    );
  }
}